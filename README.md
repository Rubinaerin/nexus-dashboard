...
### 👥 Customer Management
![Customer Panel](./assets/customers.png)

### 📈 Financial Analytics
![Financial Analysis](./assets/finance.png)

### ⚙️ System Settings (Light Mode)
![Settings Light](./assets/settings-light.png)
...
5.  **The Link Logic:** In the README code I gave you, notice the line: `![Dashboard Dark](./assets/dashboard-dark.png)`. This tells GitHub to look into the assets folder and display that specific image.
